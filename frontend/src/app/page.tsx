			...
			<div className="grid grid-cols-5 gap-8 mt-4">
				<div className="col-span-3 h-96">
					...
					<div className="grid grid-cols-4 gap-8 mt-8">
						<div className="grid col-span-2 bg-gray-100 border-2 border-white shadow-md p-4 rounded-xl">
							<h2 className="font-semibold">Total Incomes</h2>
							<p className="text-4xl opacity-80">${totalIncomes}</p>
						</div>
						<div className="grid col-span-2 bg-gray-100 border-2 border-white shadow-md p-4 rounded-xl">
							<h2 className="font-semibold">Total Expenses</h2>
							<p className="text-4xl opacity-80">${totalExpenses}</p>
						</div>
						<div className="col-start-2 col-end-4 flex flex-col justify-center items-center bg-gray-100 border-2 border-white shadow-md p-4 rounded-xl">
							<h2 className="font-semibold">Total Balance</h2>
							<p className="text-green-500 opacity-80 text-4xl">
